...
web application 
 ...
 همچنین در این اپلیکیشن ویو های ثبت نام ، ورود و خروج کاربران، تغییر رمز عبور و بازیابی رمز عبور(با ارسال لینک بازیابی گذرواژه به ایمیل کاربر) پیاده سازی شده است.   
 ب) store_app: 
...
## منوی Nav Bar
منوی Nav Bar شامل 7 گزینه میباشد:  
* خانه: صفحه اصلی سایت  
